...
--*
--* Numeric driver for a 4-digit seven-segment display with shared segments
--* and selectable anodes. Displays any numeric digit (0–F) from a 4-bit value
--* and supports selective digit blanking. Multiplexes all 4 displays at 1 kHz.
--*
--******************************************************************************
...
entity SevenSegmentDriver is
    port (
        ...
        blank3    : in  std_logic;                     -- leftmost blank
        blank2    : in  std_logic;                     -- 2nd from left blank
        blank1    : in  std_logic;                     -- 3rd from left blank
        blank0    : in  std_logic;                     -- rightmost blank
...
architecture SevenSegmentDriver_ARCH of SevenSegmentDriver is
    ...
    -- Anode select constants (active-low)
...
begin
    ...
    -- Convert 4-bit binary value to 7-segment pattern
    ...
    -- Drive anodes (blank overrides digit selection)
    ...
    -- 1 kHz scan-rate pulse generator
